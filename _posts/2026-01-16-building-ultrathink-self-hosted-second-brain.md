...
date: 2026-01-16
tags: [automation, n8n, obsidian, ai]
excerpt: "How I adapted Nate B Jones' Second Brain architecture for privacy-first, self-hosted infrastructure using Telegram, n8n, Obsidian, and a Headless Ghost."
---
...
*The full source code (Docker Compose, n8n workflows, and configs) is [available on GitHub](https://github.com/RADobson/ultrathink_2b).*
